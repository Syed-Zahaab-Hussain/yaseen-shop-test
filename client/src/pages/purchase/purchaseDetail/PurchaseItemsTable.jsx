...
import { updatePurchaseItem, deletePurchaseItem } from "@/lib/api";
...
const PurchaseItemsTable = ({ purchase }) => {
  ...
  const updateItemMutation = useMutation({
    mutationFn: (data) => updatePurchaseItem(data.id, data),
    onSuccess: () => {
  ...
  const deleteItemMutation = useMutation({
    mutationFn: (id) => deletePurchaseItem(id),
    onSuccess: () => {
      queryClient.invalidateQueries(["purchase", purchase.id]);
    },
  });
            ...
            {purchase.purchaseItems.map((item) => (
              <TableRow key={item.id}>
                ...
                <TableCell>
                  ...
                  <WarrantyClaimDialog item={item} purchaseId={purchase.id} />
                </TableCell>
              </TableRow>
            ))}
          </TableBody>
